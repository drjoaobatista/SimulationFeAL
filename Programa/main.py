...
if __name__ == '__main__':
    enviar = Enviar(nomeRef='20-05-24-tentativa15')
    descricao="testando os pontos da referencia de 2020 com b=-1 e usando o programa da tentativa 15"
  ...
  #  entrada['t0'] = [2.053,  2.030, 2.0163, 2.012, 2.012, 1.964, 1.9527, 1.9362, 1.9348, 1.899, 1.9036, 1.6072, 1.6124, 1.51274, 1.3904, 1.38057, 1.3658, 1.34357, 1.2903, 1.2316, 1.082, 1.0464, 0.97956, 0.7824, 0.5280, 0.2181098]
    ...
    experimental=[2.0938997, 2.091892414662, 2.089885129325, 2.083863273312, 2.077841417299, 2.071819561285, 2.065797705272, 2.065797705272, 2.061783134597, 2.053753993246, 2.043717566558, 2.037695710545, 2.027659283857, 2.017622857168, 2.003571859804, 1.989520862441, 1.975469865077, 1.9553970117, 1.941346014336, 1.889156595557, 1.881127454206, 1.862, 1.74, 1.682, 1.55]
    entrada['concentracao'] = [0, 0.021, 0.025, 0.04, 0.05,  0.06, 0.07,  0.075, 0.08, 0.09,  0.1,  0.11, 0.12,0.13, 0.14, 0.15, 0.16, 0.17, 0.18, 0.198, 0.2, 0.220, 0.24, 0.247, 0.265]
